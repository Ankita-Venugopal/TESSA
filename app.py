...
bg_image_base64 = get_base64_image("header.png")
...
if st.session_state.page == "home":
    ...
    if st.session_state.show_subcategories:
        ...
        with subcols[0]:
            st.image("dairy.png", width=150)
            if st.button("Go to Dairy"):
                go_to_page("dairy")

        with subcols[1]:
            st.image("frozen.png", width=150)
            if st.button("Go to Frozen"):
                go_to_page("frozen")

        with subcols[2]:
            st.image("snacks.png", width=150)
            if st.button("Go to Snacks"):
                go_to_page("snacks")

        with subcols[3]:
            st.image("beverages.png", width=150)
